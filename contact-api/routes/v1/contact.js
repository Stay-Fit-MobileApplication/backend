...
router.get('/healthcheck', mongoHealthCheck, redisHealthCheck, async (req, res) => {
  ...
  return res.status(200).json({ "response_code": 201, "message": resp[200], "response": { "database": req.mongodb, "database_code": req.code_mongodb, "cache_database": req.redis, "cache_database_code": req.code_redis, "version": "1.0", "hostname": os.hostname() } });
});
